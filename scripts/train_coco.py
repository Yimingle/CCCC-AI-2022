...
def main(exp_name,
         ...
         coco_root_path="J:\dector_frame\key_points\HRNet\datasets\COCO",
         coco_bbox_path=None,
         seed=1,
         device=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_workers", "-w", help="number of DataLoader workers", type=int, default=0)
    ...
    parser.add_argument("--coco_root_path", help="COCO dataset root path", type=str, default="J:\dector_frame\key_points\HRNet\datasets\COCO")
